    ...
    <section className="w-full my-6" id="menu">
      <div className="w-full flex flex-col items-center justify-center">
          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                } w-24 min-w-[94px] h-28 hover:bg-cartNumBg cursor-pointer rounded-lg drop-shadow-xl flex flex-col items-center
        ...
        <div className="w-full ">
          <RowContainer
            flag={false}
            foodItems={foodItems?.filter((item) => item.category === filter)}
          />
        </div>
      </div>
    </section>
