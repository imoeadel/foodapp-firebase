      ...
      <div className="w-[90%] md:w-[75%] border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          ...
          <input
            ...
            value={title}
            placeholder="Title"
            className="w-full h-full text-lg bg-transparent outline-none border-none placeholder:text-gray-40000 text-textColor"
        ...
        <div className="flex items-center w-full">
          <button
            ...
            className="ml-0 md:ml-auto w-full md:w-auto border-none outline-none
             bg-emerald-400 px-12 py-2 rounded-lg text-lg text-white font-semibold text-center "
            onClick={saveDetails}
          >
            Save
          </button>
